...
def remove_punct(text):
    ...
    for char in text:
        ...
        if not (char in string.punctuation):
        	#if it isnt character in the string e.g. punctuation
            no_punctuation = no_punctuation + char
            #make it into new text by removing punctuation
...
def exit_leads_to(exits, direction):
    ...
    #this call upon the rooms which are in an exitable direction then the directions then the full name of that room
...
def menu(exits):
    ...
    while True:
        ...
        choice_exit = input()
        # Read player's input
        normalise_exit = normalise_input(choice_exit)
        # Normalise the input
        for exit in exits:
