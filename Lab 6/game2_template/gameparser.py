...
def normalise_input(user_input):
    ...
    remove_space = remove_spaces(no_punct)
    convert = string_to_list(remove_space)
    #removes all unimportant words 
    normalised = filter_words(convert, skip_words)
    return normalised
    #
